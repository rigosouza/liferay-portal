...
public class DDMFormInstanceRecordIndexer
	...
	protected Summary doGetSummary(
		...
		long ddmFormInstanceId = GetterUtil.getLong(
			document.get("ddmFormInstanceId"));
			...
			new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					Property ddmFormInstanceRecordIdProperty =
						PropertyFactoryUtil.forName("ddmFormInstanceRecordId");
					...
					Property ddmFormInstanceProperty =
						PropertyFactoryUtil.forName("ddmFormInstanceId");
					...
					ddmFormInstanceDynamicQuery.setProjection(
						ProjectionFactoryUtil.property("ddmFormInstanceId"));
